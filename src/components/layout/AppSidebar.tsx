...
const adminNavItems = [
  ...
  { title: "Leads Intelligence", url: "/admin/leads", icon: Target },
  { title: "Finance & Payments", url: "/admin/finance", icon: DollarSign },
  { title: "Invoice Generator", url: "/admin/invoices", icon: FileText },
  { title: "SPK Generator", url: "/admin/spk", icon: FileCheck },
  { title: "AI System Control", url: "/admin/ai-control", icon: Bot },
  { title: "Subscriptions", url: "/admin/subscriptions", icon: CreditCard },
  { title: "Integrations", url: "/admin/integrations", icon: Plug },
  { title: "Audit Logs", url: "/admin/audit", icon: ScrollText },
  { title: "Team & Users", url: "/admin/team", icon: UsersRound },
...
const clientNavItems = [
  ...
  { title: "Chat Logs", url: "/dashboard/chats", icon: MessageSquare },
  { title: "Knowledge Base", url: "/dashboard/knowledge", icon: Brain },
  { title: "Products", url: "/dashboard/products", icon: ShoppingCart },
  { title: "Bot Personality", url: "/dashboard/personality", icon: Sparkles },
